      ...
      <div className="container px-6 mx-auto space-y-6 divide-y divide-gray-400 md:space-y-12 divide-opacity-50">
        <div className="grid grid-cols-12">
            ...
            >
              <div className="flex flex-col items-center justify-center">
                <img
                  ...
                  alt="cyberlearn.vn"
                />
                <span className="self-center text-4xl font-bold text-yellow-600 uppercase">
                  Cyber Cinema
                </span>
              </div>
            </a>
          ...
          <div className="col-span-6 text-center md:text-left md:col-span-3">
            <p className="pb-1 text-lg font-bold text-yellow-600">PARTNER</p>
            <ul className="grid grid-cols-3 gap-3" style={{ width: 200 }}>
              {arrHeThongRap.map((htr, index) => {
                return (
                  <li key={index}>
                    <img src={htr.logo} alt={htr.tenHeThongRap} />
                  </li>
                );
              })}
            </ul>
          ...
          <div className="col-span-6 text-center md:text-left md:col-span-3">
            <p className="pb-1 text-lg font-bold uppercase text-yellow-600">
              ABOUT Cyber Cinema
            </p>
            <ul>
              <li className="pb-5">
